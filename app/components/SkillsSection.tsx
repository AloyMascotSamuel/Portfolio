  ...
  return (
    <section id="skills" className="min-h-screen px-3 py-6 lg:p-0 lg:mb-16">
      <div className="w-full bg-[#111111]/95 backdrop-blur-sm p-6 lg:p-12 border border-gray-800/50">
        ...
        <h2 className="text-4xl lg:text-5xl font-medium text-white mb-16">Skills & Knowledge</h2>
        ...
        <div className="mt-20 grid md:grid-cols-2 gap-8">
          <div className="bg-[#111111] p-8  border border-gray-800/50">
            ...
            <div className="flex flex-wrap gap-2">
              {['React', 'Node.js', 'Python', 'Go', 'TypeScript', 'PostgreSQL', 'MongoDB', 'AWS', 'Docker', 'Kubernetes', 'GraphQL', 'REST APIs'].map((tech, i) => (
                <span 
                  key={i}
                  className="px-4 py-2 bg-[#1a1a1a] text-gray-300  text-sm border border-gray-800 hover:border-[#8cc63f] hover:text-[#8cc63f] transition-all duration-200"
                >
                  {tech}
                </span>
              ))}
