  ...
  return (
    <section id="resume" className="min-h-screen px-3 py-6 lg:p-0 lg:mb-16">
      <div className="w-full bg-[#111111]/95 backdrop-blur-sm rounded-2xl p-6 lg:p-12 border border-gray-800/50">
        ...
        <h2 className="text-4xl lg:text-5xl font-bold text-white mb-16">Resume</h2>
        
        {/* Experience */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-white mb-10 flex items-center gap-3">
            <span className="w-10 h-10 rounded-lg bg-[#8cc63f]/20 border border-[#8cc63f]/30 flex items-center justify-center">
              <svg className="w-5 h-5 text-[#8cc63f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <div key={index} className="relative pl-10 border-l-2 border-gray-700/50">
                ...
                <div className="bg-[#1a1a1a] p-6 rounded-xl border border-gray-800/50 hover:border-gray-700 transition-all duration-300 hover:shadow-xl hover:shadow-[#8cc63f]/10">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {education.map((edu, index) => (
              <div 
                key={index} 
                className="bg-[#1a1a1a] p-6 rounded-xl border border-gray-800/50 hover:border-gray-700 transition-all duration-300 hover:shadow-xl hover:shadow-[#8cc63f]/10"
              >
